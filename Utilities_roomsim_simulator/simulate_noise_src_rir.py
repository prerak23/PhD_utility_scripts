...
import yaml
with open('conf_sim_params.yml') as file_c,open('conf_room_setup_1.yml') as file_1 , open('conf_receivers_1.yml') as file_2,open('conf_source_1.yml') as file_4:
...
for i in tqdm(range(no_of_rooms)):
    ...
    for j in range(no_of_view_points):
        ...
        print(tmp_.shape)
        np.save("roomsim_alpha_check_48khz.npy",tmp_)
