...
abc=np.load("vp_1_test_snr_above_0db_high_reverb.npy")
abcd=np.load("vp_1_test_snr_above_0db_mid_reverb.npy")
abcde=np.load("vp_1_test_snr_above_0db_less_reverb.npy")
#abcdef=np.load("vp5_weightmean_test.npy")
...
#ep=10e-5
bplot1=axs[0,0].boxplot([err_9,err2_9,err3_9],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[0,0].set_xticks([1,2,3])
axs[0,0].set_xticklabels(['H','M','L',],rotation=45)
...
bplot2=axs[0,1].boxplot([err_10,err2_10,err3_10],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[0,1].set_xticks([1,2,3])
axs[0,1].set_xticklabels(['H','M','L'],rotation=45)
axs[0,1].set_ylabel("Abs Err Ab")
axs[0,1].set_title("AB Coeff 250hz")


bplot3=axs[1,0].boxplot([err_11,err2_11,err3_11],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[1,0].set_xticks([1,2,3])
axs[1,0].set_xticklabels(['H','M','L'],rotation=45)
axs[1,0].set_ylabel("Abs Err Ab")
axs[1,0].set_title("AB Coeff 500hz")


bplot4=axs[1,1].boxplot([err_12,err2_12,err3_12],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[1,1].set_xticks([1,2,3])
axs[1,1].set_xticklabels(['H','M','L'],rotation=45)
axs[1,1].set_ylabel("Abs Err Ab")
axs[1,1].set_title("Ab Coeff 1000hz")


bplot5=axs[2,0].boxplot([err_13,err2_13,err3_13],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[2,0].set_xticks([1,2,3])
axs[2,0].set_xticklabels(['H','M','L'],rotation=45)
axs[2,0].set_ylabel("Abs Err Ab")
axs[2,0].set_title("Ab Coeff 2000hz")


bplot6=axs[2,1].boxplot([err_14,err2_14,err3_14],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[2,1].set_xticks([1,2,3])
axs[2,1].set_xticklabels(['H','M','L'],rotation=45)
axs[2,1].set_ylabel("Abs Err Ab")
axs[2,1].set_title("Ab Coeff 4000hz")


out_rt=True
bplot7=axs[3,0].boxplot([err_3,err2_3,err3_3],showmeans=True,vert=True,showfliers=out_rt,patch_artist=True)
axs[3,0].set_xticks([1,2,3])
axs[3,0].set_xticklabels(['H','M','L'],rotation=45)
...
bplot8=axs[3,1].boxplot([err_4,err2_4,err3_4],showmeans=True,vert=True,showfliers=out_rt,patch_artist=True)
axs[3,1].set_xticks([1,2,3])
axs[3,1].set_xticklabels(['H','M','L'],rotation=45)
axs[3,1].set_ylabel("Abs Err Sec")
axs[3,1].set_title("RT 60 250hz")


bplot9=axs[4,0].boxplot([err_5,err2_5,err3_5],showmeans=True,vert=True,showfliers=out_rt,patch_artist=True)
axs[4,0].set_xticks([1,2,3])
axs[4,0].set_xticklabels(['H','M','L'],rotation=45)
axs[4,0].set_ylabel("Abs Err Sec")
axs[4,0].set_title("RT 60 500hz")
        
bplot10=axs[4,1].boxplot([err_6,err2_6,err3_6],showmeans=True,vert=True,showfliers=out_rt,patch_artist=True)
axs[4,1].set_xticks([1,2,3])
axs[4,1].set_xticklabels(['H','M','L'],rotation=45)
axs[4,1].set_ylabel("Abs Err Sec")
axs[4,1].set_title("RT60 1000hz")


bplot11=axs[5,0].boxplot([err_7,err2_7,err3_7],showmeans=True,vert=True,showfliers=out_rt,patch_artist=True)
axs[5,0].set_xticks([1,2,3])
axs[5,0].set_xticklabels(['H','M','L'],rotation=45)
axs[5,0].set_ylabel("Abs Err Sec")
axs[5,0].set_title("RT 60 2000hz")


bplot12=axs[5,1].boxplot([err_8,err2_8,err3_8],showmeans=True,vert=True,showfliers=out_rt,patch_artist=True)
axs[5,1].set_xticks([1,2,3])
axs[5,1].set_xticklabels(['H','M','L'],rotation=45)
axs[5,1].set_ylabel("Abs Err Sec")
axs[5,1].set_title("RT 60 4000hz")

bplot13=axs[6,0].boxplot([err_1,err2_1,err3_1],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[6,0].set_xticks([1,2,3])
axs[6,0].set_xticklabels(['H','M','L'],rotation=45)
axs[6,0].set_ylabel("Abs Err M2")
axs[6,0].set_title("Surface")

bplot14=axs[6,1].boxplot([err_2,err2_2,err3_2],showmeans=True,vert=True,showfliers=True,patch_artist=True)
axs[6,1].set_xticks([1,2,3])
axs[6,1].set_xticklabels(['H','M','L'],rotation=45)
...
plt.savefig("test_mono_comparasion_robustness.png")
