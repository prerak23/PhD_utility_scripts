...
test_set=np.load("/home/psrivastava/baseline/scripts/pre_processing/robustness/test_set_snr_above_zero.npy")
...
class load_data_test():
    ...
    def return_data(self,room_id):
        ...
        test_room_vp=np.where(test_set=="room_"+str(room_id))[0][0]
        vp=int(test_set[test_room_vp][1])
